...
public class ContainerTsar extends AbstractContainerMenu implements BombContainer {
	...
	public ContainerTsar(int syncId, Inventory inventoryPlayer, Container tsarBomb, ContainerData containerData) {
        super(RivalRebelsGuiHandler.TSAR_SCREEN_HANDLER_TYPE.get(), syncId);
		...
		for (int i = 0; i <= 3; i++)
		{
			...
			addSlot(new SlotRR(tsarBomb, i + 7, 62 + i * 18, 37, 1, RRItems.NUCLEAR_ROD).setAcceptsTrollface(true));
