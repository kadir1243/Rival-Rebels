...
public class RRItems {
    ...
    public static final DeferredItem<Item> flamethrower = ITEMS.registerItem("flamethrower", properties -> new ItemFlameThrower(properties.component(RRComponents.FLAME_THROWER_MODE, FlameThrowerMode.DEFAULT)), new Item.Properties().stacksTo(1));
    public static final DeferredItem<Item> tesla = ITEMS.registerItem("tesla", ItemTesla::new);
    ...
    public static final DeferredItem<Item> remote = ITEMS.registerItem("remote", ItemRemote::new);
    ...
    public static final DeferredItem<Item> hydrod = ITEMS.registerItem("hydrogen_rod", p -> new Item(p.durability(32).component(RRComponents.ROD_POWER, 250000)));
    ...
    public static final DeferredItem<Item> core1 = ITEMS.registerItem("copper_core", p -> new Item(p.component(RRComponents.CORE_TIME_MULTIPLIER, 0.25F).stacksTo(1)));
    public static final DeferredItem<Item> core2 = ITEMS.registerItem("tungsten_core", p -> new Item(p.component(RRComponents.CORE_TIME_MULTIPLIER, 0.75F).stacksTo(1)));
    public static final DeferredItem<Item> core3 = ITEMS.registerItem("titanium_core", p -> new Item(p.component(RRComponents.CORE_TIME_MULTIPLIER, 1F).stacksTo(1)));
    public static final DeferredItem<Item> binoculars = ITEMS.registerItem("binoculars", ItemBinoculars::new);
    public static final DeferredItem<Item> camera = ITEMS.registerItem("camera", ItemCamera::new, new Item.Properties().stacksTo(1));
    public static final DeferredItem<Item> chip = ITEMS.registerItem("chip", ItemChip::new, new Item.Properties().stacksTo(1));
    public static final DeferredItem<Item> roda = ITEMS.registerItem("roda", ItemRoda::new);
    ...
    public static final DeferredItem<Item> orebelhelmet = ITEMS.registerItem("orebelhelmet",  p -> new Item(p.humanoidArmor(orebelarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> orebelchest = ITEMS.registerItem("orebelchest",  p -> new Item(p.humanoidArmor(orebelarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> orebelpants = ITEMS.registerItem("orebelpants",  p -> new Item(p.humanoidArmor(orebelarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> orebelboots = ITEMS.registerItem("orebelboots",  p -> new Item(p.humanoidArmor(orebelarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> onukerhelmet = ITEMS.registerItem("onukerhelmet",  p -> new Item(p.humanoidArmor(onukerarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> onukerchest = ITEMS.registerItem("onukerchest",  p -> new Item(p.humanoidArmor(onukerarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> onukerpants = ITEMS.registerItem("onukerpants",  p -> new Item(p.humanoidArmor(onukerarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> onukerboots = ITEMS.registerItem("onukerboots",  p -> new Item(p.humanoidArmor(onukerarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> ointelhelmet = ITEMS.registerItem("ointelhelmet",  p -> new Item(p.humanoidArmor(ointelarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> ointelchest = ITEMS.registerItem("ointelchest",  p -> new Item(p.humanoidArmor(ointelarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> ointelpants = ITEMS.registerItem("ointelpants",  p -> new Item(p.humanoidArmor(ointelarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> ointelboots = ITEMS.registerItem("ointelboots",  p -> new Item(p.humanoidArmor(ointelarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> ohackerhelmet = ITEMS.registerItem("ohackerhelmet",  p -> new Item(p.humanoidArmor(ohackerarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> ohackerchest = ITEMS.registerItem("ohackerchest",  p -> new Item(p.humanoidArmor(ohackerarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> ohackerpants = ITEMS.registerItem("ohackerpants",  p -> new Item(p.humanoidArmor(ohackerarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> ohackerboots = ITEMS.registerItem("ohackerboots",  p -> new Item(p.humanoidArmor(ohackerarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> srebelhelmet = ITEMS.registerItem("srebelhelmet",  p -> new Item(p.humanoidArmor(srebelarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> srebelchest = ITEMS.registerItem("srebelchest",  p -> new Item(p.humanoidArmor(srebelarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> srebelpants = ITEMS.registerItem("srebelpants",  p -> new Item(p.humanoidArmor(srebelarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> srebelboots = ITEMS.registerItem("srebelboots",  p -> new Item(p.humanoidArmor(srebelarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> snukerhelmet = ITEMS.registerItem("snukerhelmet",  p -> new Item(p.humanoidArmor(snukerarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> snukerchest = ITEMS.registerItem("snukerchest",  p -> new Item(p.humanoidArmor(snukerarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> snukerpants = ITEMS.registerItem("snukerpants",  p -> new Item(p.humanoidArmor(snukerarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> snukerboots = ITEMS.registerItem("snukerboots",  p -> new Item(p.humanoidArmor(snukerarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> sintelhelmet = ITEMS.registerItem("sintelhelmet",  p -> new Item(p.humanoidArmor(sintelarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> sintelchest = ITEMS.registerItem("sintelchest",  p -> new Item(p.humanoidArmor(sintelarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> sintelpants = ITEMS.registerItem("sintelpants",  p -> new Item(p.humanoidArmor(sintelarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> sintelboots = ITEMS.registerItem("sintelboots",  p -> new Item(p.humanoidArmor(sintelarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> shackerhelmet = ITEMS.registerItem("shackerhelmet",  p -> new Item(p.humanoidArmor(shackerarmor, ArmorType.HELMET)));
    public static final DeferredItem<Item> shackerchest = ITEMS.registerItem("shackerchest",  p -> new Item(p.humanoidArmor(shackerarmor, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> shackerpants = ITEMS.registerItem("shackerpants",  p -> new Item(p.humanoidArmor(shackerarmor, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> shackerboots = ITEMS.registerItem("shackerboots",  p -> new Item(p.humanoidArmor(shackerarmor, ArmorType.BOOTS)));
    public static final DeferredItem<Item> camohat = ITEMS.registerItem("camohat",  p -> new Item(p.humanoidArmor(armorCamo, ArmorType.HELMET)));
    public static final DeferredItem<Item> camoshirt = ITEMS.registerItem("camoshirt",  p -> new Item(p.humanoidArmor(armorCamo, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> camopants = ITEMS.registerItem("camopants",  p -> new Item(p.humanoidArmor(armorCamo, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> camoshoes = ITEMS.registerItem("camoshoes",  p -> new Item(p.humanoidArmor(armorCamo, ArmorType.BOOTS)));
    public static final DeferredItem<Item> camohat2 = ITEMS.registerItem("camohat2",  p -> new Item(p.humanoidArmor(armorCamo2, ArmorType.HELMET)));
    public static final DeferredItem<Item> camoshirt2 = ITEMS.registerItem("camoshirt2",  p -> new Item(p.humanoidArmor(armorCamo2, ArmorType.CHESTPLATE)));
    public static final DeferredItem<Item> camopants2 = ITEMS.registerItem("camopants2",  p -> new Item(p.humanoidArmor(armorCamo2, ArmorType.LEGGINGS)));
    public static final DeferredItem<Item> camoshoes2 = ITEMS.registerItem("camoshoes2", p -> new Item(p.humanoidArmor(armorCamo2, ArmorType.BOOTS)));
