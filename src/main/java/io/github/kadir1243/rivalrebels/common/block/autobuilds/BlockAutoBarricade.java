...
public class BlockAutoBarricade extends BlockAutoTemplate {
	...
	public void build(Level level, int x, int y, int z) {
		...
		placeBlockCarefully(level, x, y + 3, z - 1, RRBlocks.steel);
		placeBlockCarefully(level, x - 1, y + 3, z, RRBlocks.steel);
		placeBlockCarefully(level, x, y + 3, z - 2, RRBlocks.ffreciever.get().defaultBlockState().setValue(BlockReciever.FACING, Direction.NORTH));
		placeBlockCarefully(level, x, y + 3, z + 2, RRBlocks.ffreciever.get().defaultBlockState().setValue(BlockReciever.FACING, Direction.SOUTH));
		placeBlockCarefully(level, x - 2, y + 3, z, RRBlocks.ffreciever.get().defaultBlockState().setValue(BlockReciever.FACING, Direction.WEST));
		placeBlockCarefully(level, x + 2, y + 3, z, RRBlocks.ffreciever.get().defaultBlockState().setValue(BlockReciever.FACING, Direction.EAST));
