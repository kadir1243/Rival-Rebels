...
public class BlockToxicGas extends Block {
    ...
    public void animateTick(BlockState state, Level world, BlockPos pos, RandomSource random) {
        ...
        double y = center.y();
        double z = center.z();
        world.addParticle(ParticleTypes.SMOKE, x, y, z, (random.nextFloat() - 0.5) * 0.1, (random.nextFloat() - 0.5) * 0.1, (random.nextFloat() - 0.5) * 0.1);
		world.addParticle(ParticleTypes.ENCHANT, x, y, z, (random.nextFloat() - 0.5) * 0.1, (random.nextFloat() - 0.5) * 0.1, (random.nextFloat() - 0.5) * 0.1);
	}
}
