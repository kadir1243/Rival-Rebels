...
public class RRBlocks {
    ...
    public static final DeferredBlock<Block> flag1 = BLOCKS.registerBlock("flag1", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> trollFlag = BLOCKS.registerBlock("troll_flag", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag3 = BLOCKS.registerBlock("flag3", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag4 = BLOCKS.registerBlock("flag4", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag5 = BLOCKS.registerBlock("flag5", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag6 = BLOCKS.registerBlock("flag6", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag7 = BLOCKS.registerBlock("flag7", BlockFlag::new, () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> light = BLOCKS.registerBlock("light", BlockLight::new, () -> Properties.of().pushReaction(PushReaction.BLOCK).noCollision().noOcclusion().noLootTable().lightLevel(state -> 15));
    public static final DeferredBlock<Block> light2 = BLOCKS.registerBlock("light2", BlockLight::new, () -> Properties.of().pushReaction(PushReaction.BLOCK).noCollision().noOcclusion().noLootTable().lightLevel(state -> 15));
