...
public class RRBlocks {
    ...
    public static final DeferredBlock<Block> aquicksand = BLOCKS.registerBlock("aquicksand", BlockQuickSand::new, () -> Properties.of().mapColor(MapColor.DIRT).strength(0.5F).noOcclusion().noCollision());
    ...
    public static final DeferredBlock<Block> flare = BLOCKS.registerBlock("flare", BlockFlare::new, () -> Properties.of().mapColor(MapColor.COLOR_BROWN).ignitedByLava().noLootTable().noOcclusion().noCollision().lightLevel(state -> 5));
    ...
    public static final DeferredBlock<Block> goreblock = BLOCKS.registerBlock("goreblock", BlockGore::new, () -> Properties.of().pushReaction(PushReaction.DESTROY).noLootTable().noCollision().noOcclusion().instabreak());
    ...
    public static final DeferredBlock<Block> flag1 = BLOCKS.registerBlock("flag1", p -> new BlockFlag(p, "bi"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> trollFlag = BLOCKS.registerBlock("troll_flag", p -> new BlockFlag(p, "dd"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag3 = BLOCKS.registerBlock("flag3", p -> new BlockFlag(p, "ar"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag4 = BLOCKS.registerBlock("flag4", p -> new BlockFlag(p, "aw"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag5 = BLOCKS.registerBlock("flag5", p -> new BlockFlag(p, "aq"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag6 = BLOCKS.registerBlock("flag6", p -> new BlockFlag(p, "al"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> flag7 = BLOCKS.registerBlock("flag7", p -> new BlockFlag(p, "aj"), () -> Properties.of().ignitedByLava().noOcclusion().noCollision());
    public static final DeferredBlock<Block> light = BLOCKS.registerBlock("light", p -> new BlockLight(p, 23), () -> Properties.of().pushReaction(PushReaction.BLOCK).noCollision().noOcclusion().noLootTable().lightLevel(state -> 15));
    public static final DeferredBlock<Block> light2 = BLOCKS.registerBlock("light2", p -> new BlockLight(p, -1), () -> Properties.of().pushReaction(PushReaction.BLOCK).noCollision().noOcclusion().noLootTable().lightLevel(state -> 15));
    ...
    public static final DeferredBlock<Block> meltdown = BLOCKS.registerBlock("meltdown", BlockMeltDown::new, () -> Properties.of().pushReaction(PushReaction.BLOCK).noCollision().noOcclusion().noLootTable().strength(0.5F, 10F));
    public static final DeferredBlock<Block> plasmaexplosion = BLOCKS.registerBlock("plasma_explosion", BlockPlasmaExplosion::new, () -> Properties.of().pushReaction(PushReaction.BLOCK).noCollision().noOcclusion().noLootTable().lightLevel(state -> 15));
    public static final DeferredBlock<Block> toxicgas = BLOCKS.registerBlock("toxicgas", BlockToxicGas::new, () -> Properties.of().pushReaction(PushReaction.BLOCK).noLootTable().noCollision().randomTicks().noOcclusion().strength(-1.0F, 3600000.0F));
    ...
    public static final DeferredBlock<Block> quicksand = BLOCKS.registerBlock("quicksand", BlockQuickSand::new, () -> Properties.of().mapColor(MapColor.DIRT).noOcclusion().strength(0.5F).noCollision());
    ...
    private static void registerBlockColors(RegisterColorHandlersEvent.BlockTintSources event) {
        ...
        event.register(event.getBlockColors().getTintSources(Blocks.GRASS_BLOCK.defaultBlockState()), RRBlocks.mario.get(), RRBlocks.landmine.get(), RRBlocks.quicksand.get());
    }
}
