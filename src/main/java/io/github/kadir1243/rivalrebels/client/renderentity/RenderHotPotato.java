...
@OnlyIn(Dist.CLIENT)
public class RenderHotPotato extends EntityRenderer<EntityHotPotato, RenderHotPotato.State> {
    ...
    @Override
    public void extractRenderState(EntityHotPotato p_entity, State reusedState, float partialTick) {
