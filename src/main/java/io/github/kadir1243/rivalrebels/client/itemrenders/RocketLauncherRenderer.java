...
public class RocketLauncherRenderer implements SpecialModelRenderer<Boolean> {
    ...
    public void submit(@Nullable Boolean isDamaged, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, int overlayCoords, boolean hasFoil, int outlineColor) {
		...
		ModelRocketLauncherBody.render(poseStack, submitNodeCollector, RenderTypes.entitySolid(RRIdentifiers.etrocketlauncherbody), lightCoords, overlayCoords);
		if (isDamaged) {
		...
		ModelRocketLauncherTube.render(poseStack, submitNodeCollector, rocketLauncherTubeRenderType, lightCoords, overlayCoords);
		poseStack.popPose();
