...
public class ModelRocketLauncherTube {
	...
	public static void render(PoseStack pose, VertexConsumer buffer, int light, int overlay) {
		ModelBlockRenderer.renderModel(pose.last(), buffer, BAKED_MODEL.get().blockStateModel(), 1, 1, 1, light, overlay);
	}
}
