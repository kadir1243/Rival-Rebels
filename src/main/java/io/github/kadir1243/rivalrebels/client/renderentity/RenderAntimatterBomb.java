...
public class RenderAntimatterBomb extends EntityRenderer<EntityAntimatterBomb, RenderAntimatterBomb.State> {
    ...
    public void render(State renderState, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
        ...
        ObjModels.render(bombModel, bufferSource.getBuffer(RenderType.entitySolid(RRIdentifiers.etantimatterbomb)), poseStack, CommonColors.WHITE, packedLight, OverlayTexture.NO_OVERLAY);
        poseStack.popPose();
    }
