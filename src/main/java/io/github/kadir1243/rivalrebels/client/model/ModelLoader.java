...
public class ModelLoader
{
    ...
    private static final Supplier<QuadHelper.BakedData> BAKED_MODEL_A = QuadHelper.createBakedModel(buffer -> {
        ...
        QuadHelper.addFace(buffer, lloader4, lloader3, rloader3, rloader4, l4, l3s, r3s, r4);
        QuadHelper.addFace(buffer, lloader5, lloader4, rloader4, rloader5, l5, l4, r4, r5);
        QuadHelper.addFace(buffer, lloader6, lloader5, rloader5, rloader6, l6f, l5, r5, r6f);
        QuadHelper.addFace(buffer, lloader7, lloader6, rloader6, rloader7, l7, l6s, r6s, r7);
        QuadHelper.addFace(buffer, lloader8, lloader7, rloader7, rloader8, l8, l7, r7, r8);
        QuadHelper.addFace(buffer, lloader9, lloader8, rloader8, rloader9, l9, l8, r8, r9);
        QuadHelper.addFace(buffer, lloader10, lloader9, rloader9, rloader10, l10, l9, r9, r10);
        QuadHelper.addFace(buffer, lloader11, lloader10, rloader10, rloader11, l11, l10, r10, r11);
        QuadHelper.addFace(buffer, lloader12, lloader11, rloader11, rloader12, l12f, l11, r11, r12f);
        QuadHelper.addFace(buffer, lloader1, lloader2, lloader11, lloader12, ls6, ls5, ls8, ls7);
        QuadHelper.addFace(buffer, lloader2, lloader3, lloader10, lloader11, ls5, ls4, ls9, ls8);
        QuadHelper.addFace(buffer, lloader3, lloader4, lloader9, lloader10, ls4, ls3, ls10, ls9);
        QuadHelper.addFace(buffer, lloader4, lloader5, lloader8, lloader9, ls3, ls2, ls11, ls10);
        QuadHelper.addFace(buffer, lloader5, lloader6, lloader7, lloader8, ls2, ls1, ls12, ls11);
        QuadHelper.addFace(buffer, rloader2, rloader1, rloader12, rloader11, rs8, rs7, rs6, rs5);
        QuadHelper.addFace(buffer, rloader3, rloader2, rloader11, rloader10, rs9, rs8, rs5, rs4);
        QuadHelper.addFace(buffer, rloader4, rloader3, rloader10, rloader9, rs10, rs9, rs4, rs3);
    ...
    private static final Supplier<QuadHelper.BakedData> BAKED_MODEL_B = QuadHelper.createBakedModel(buffer -> {
        QuadHelper.addFace(buffer, vfront1, vfront2, vfront3, vfront4, front1, front2, front3, front4);
        QuadHelper.addFace(buffer, vfront5, vfront1, vfront4, vfront6, front5, front1, front4, front6);
        QuadHelper.addFace(buffer, vpanel5, vpanel6, vpanel7, vpanel8, panel5, panel6, panel7, panel8);
        QuadHelper.addFace(buffer, vpanel1, vpanel5, vpanel8, vpanel4, panel1, panel5, panel8, panel4);
        QuadHelper.addFace(buffer, vpanel1, vpanel2, vpanel6, vpanel5, panel1, panel2, panel6, panel5);
        QuadHelper.addFace(buffer, vpanel6, vpanel2, vpanel3, vpanel7, panel6, panel2, panel3, panel7);
        QuadHelper.addFace(buffer, vpanel8, vpanel7, vpanel3, vpanel4, panel8, panel7, panel3, panel4);
        QuadHelper.addFace(buffer, vfront1, vfront5, vcside1, vcside2, cside2, cside1, cside6, cside5);
        QuadHelper.addFace(buffer, vfront6, vfront4, vcside5, vcside6, cside1, cside2, cside5, cside6);
        QuadHelper.addFace(buffer, vfront2, vfront1, vcside2, vcside3, cside3, cside2, cside5, cside4);
        QuadHelper.addFace(buffer, vfront4, vfront3, vcside4, vcside5, cside2, cside3, cside4, cside5);
        QuadHelper.addFace(buffer, vcside1, vfront5, vfront6, vcside6, ctop4, ctop1, ctop2, ctop3);
