...
public class ModelLoader
{
    ...
    private static final Supplier<List<QuadHelper.BakedQuadWrapper>> BAKED_MODEL_A = QuadHelper.createQuads(Sheets.BLOCKS_MAPPER.apply(RRIdentifiers.etloader), quads -> {
        QuadHelper.addFace(quads, lloader1, lloader12, rloader12, rloader1, l1f, l12s, r12s, r1f);
        QuadHelper.addFace(quads, lloader2, lloader1, rloader1, rloader2, l2, l1s, r1s, r2);
        QuadHelper.addFace(quads, lloader3, lloader2, rloader2, rloader3, l3f, l2, r2, r3f);
        QuadHelper.addFace(quads, lloader4, lloader3, rloader3, rloader4, l4, l3s, r3s, r4);
        QuadHelper.addFace(quads, lloader5, lloader4, rloader4, rloader5, l5, l4, r4, r5);
        QuadHelper.addFace(quads, lloader6, lloader5, rloader5, rloader6, l6f, l5, r5, r6f);
        QuadHelper.addFace(quads, lloader7, lloader6, rloader6, rloader7, l7, l6s, r6s, r7);
        QuadHelper.addFace(quads, lloader8, lloader7, rloader7, rloader8, l8, l7, r7, r8);
        QuadHelper.addFace(quads, lloader9, lloader8, rloader8, rloader9, l9, l8, r8, r9);
        QuadHelper.addFace(quads, lloader10, lloader9, rloader9, rloader10, l10, l9, r9, r10);
        QuadHelper.addFace(quads, lloader11, lloader10, rloader10, rloader11, l11, l10, r10, r11);
        QuadHelper.addFace(quads, lloader12, lloader11, rloader11, rloader12, l12f, l11, r11, r12f);
        QuadHelper.addFace(quads, lloader1, lloader2, lloader11, lloader12, ls6, ls5, ls8, ls7);
        QuadHelper.addFace(quads, lloader2, lloader3, lloader10, lloader11, ls5, ls4, ls9, ls8);
        QuadHelper.addFace(quads, lloader3, lloader4, lloader9, lloader10, ls4, ls3, ls10, ls9);
        QuadHelper.addFace(quads, lloader4, lloader5, lloader8, lloader9, ls3, ls2, ls11, ls10);
        QuadHelper.addFace(quads, lloader5, lloader6, lloader7, lloader8, ls2, ls1, ls12, ls11);
        QuadHelper.addFace(quads, rloader2, rloader1, rloader12, rloader11, rs8, rs7, rs6, rs5);
        QuadHelper.addFace(quads, rloader3, rloader2, rloader11, rloader10, rs9, rs8, rs5, rs4);
        QuadHelper.addFace(quads, rloader4, rloader3, rloader10, rloader9, rs10, rs9, rs4, rs3);
        QuadHelper.addFace(quads, rloader5, rloader4, rloader9, rloader8, rs11, rs10, rs3, rs2);
        QuadHelper.addFace(quads, rloader6, rloader5, rloader8, rloader7, rs12, rs11, rs2, rs1);
    });
	...
	public static void renderA(SubmitNodeCollector nodeCollector, RenderType renderType, PoseStack matrices, int light, int overlay) {
        QuadHelper.submitQuadSupplier(nodeCollector, matrices, renderType, BAKED_MODEL_A, light, overlay);
	}
    ...
    private static final Supplier<List<QuadHelper.BakedQuadWrapper>> BAKED_MODEL_B = QuadHelper.createQuads(Sheets.BLOCKS_MAPPER.apply(RRIdentifiers.etloader), quads -> {
        QuadHelper.addFace(quads, vfront1, vfront2, vfront3, vfront4, front1, front2, front3, front4);
        QuadHelper.addFace(quads, vfront5, vfront1, vfront4, vfront6, front5, front1, front4, front6);
        QuadHelper.addFace(quads, vpanel5, vpanel6, vpanel7, vpanel8, panel5, panel6, panel7, panel8);
        QuadHelper.addFace(quads, vpanel1, vpanel5, vpanel8, vpanel4, panel1, panel5, panel8, panel4);
        QuadHelper.addFace(quads, vpanel1, vpanel2, vpanel6, vpanel5, panel1, panel2, panel6, panel5);
        QuadHelper.addFace(quads, vpanel6, vpanel2, vpanel3, vpanel7, panel6, panel2, panel3, panel7);
        QuadHelper.addFace(quads, vpanel8, vpanel7, vpanel3, vpanel4, panel8, panel7, panel3, panel4);
        QuadHelper.addFace(quads, vfront1, vfront5, vcside1, vcside2, cside2, cside1, cside6, cside5);
        QuadHelper.addFace(quads, vfront6, vfront4, vcside5, vcside6, cside1, cside2, cside5, cside6);
        QuadHelper.addFace(quads, vfront2, vfront1, vcside2, vcside3, cside3, cside2, cside5, cside4);
        QuadHelper.addFace(quads, vfront4, vfront3, vcside4, vcside5, cside2, cside3, cside4, cside5);
        QuadHelper.addFace(quads, vcside1, vfront5, vfront6, vcside6, ctop4, ctop1, ctop2, ctop3);
        QuadHelper.addFace(quads, vfront2, vcside3, vcside4, vfront3, ctop2, ctop3, ctop4, ctop1);
    });
	...
	public static void renderB(SubmitNodeCollector nodeCollector, RenderType renderType, PoseStack matrices, float slide, int light, int overlay) {
        ...
        QuadHelper.submitQuadSupplier(nodeCollector, matrices, renderType, BAKED_MODEL_B, light, overlay);
        matrices.popPose();
	}
