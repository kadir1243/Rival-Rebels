...
public class RRTextures {
    ...
    public static final Identifier button_disabled = RRIdentifiers.create("textures/gui/button_disabled.png");
    public static final Identifier button_enabled = RRIdentifiers.create("textures/gui/button_enabled.png");
    public static final Identifier button_hovered = RRIdentifiers.create("textures/gui/button_hovered.png");
    public static final Identifier guitspawn = RRIdentifiers.create("textures/gui/b.png");
    public static final Identifier guitclass = RRIdentifiers.create("textures/gui/c.png");
    ...
    public static final Identifier guitwarning0 = RRIdentifiers.create("textures/gui/l.png");
    public static final Identifier guitwarning1 = RRIdentifiers.create("textures/gui/m.png");
    ...
    public static final Identifier guibinoculars = RRIdentifiers.create("textures/gui/o.png");
    public static final Identifier guibinocularsoverlay = RRIdentifiers.create("textures/gui/p.png");
    ...
    public static final Identifier guiflamethrower = RRIdentifiers.create("textures/gui/u.png");
    public static final Texture guirhodesline = new Texture("textures/gui/rhodes-gui_line.png", 1600, 900);
    public static final Identifier guirhodesout = RRIdentifiers.create("textures/gui/rhodes-gui_out.png");
    public static final Identifier guirhodeshelp = RRIdentifiers.create("textures/gui/rhodes-gui_help.png");
    public static final Identifier guicarpet = RRIdentifiers.create("textures/gui/v.png");
