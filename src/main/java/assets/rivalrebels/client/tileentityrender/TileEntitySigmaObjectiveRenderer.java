...
public class TileEntitySigmaObjectiveRenderer extends TileEntitySpecialRenderer<TileEntitySigmaObjective> {
    ...
    @Override
    public void renderTileEntityAt(TileEntitySigmaObjective te, double x, double y, double z, float partialTicks, int destroyStage) {
        GL11.glPushMatrix();
