...
public class TileEntityOmegaObjectiveRenderer implements BlockEntityRenderer<TileEntityOmegaObjective>, CustomRenderBoxExtension<TileEntityOmegaObjective> {
	public static final SpriteIdentifier ETOMEGA = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, RRIdentifiers.etomegaobj);
    ...
    public void render(TileEntityOmegaObjective entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        VertexConsumer buffer = ETOMEGA.getVertexConsumer(vertexConsumers, RenderLayer::getEntitySolid);
    ...
    @Override
    public Box getRenderBoundingBox(TileEntityOmegaObjective blockEntity) {
