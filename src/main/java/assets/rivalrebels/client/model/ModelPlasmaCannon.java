...
public class ModelPlasmaCannon
{
	...
	public void render()
	{
		...
		RenderHelper.addFace(buffer, vs2, vs1, vs4, vs3, bodyside);
		RenderHelper.addFace(buffer, vs6, vs5, vs8, vs7, bodyside);
		RenderHelper.addFace(buffer, vs1, vt1, vt4, vs5, bodytopback);
		RenderHelper.addFace(buffer, vs2, vs1, vs5, vs6, bodyback);
		RenderHelper.addFace(buffer, vt2, vf1, vf2, vt3, bodytopfront);
		RenderHelper.addFace(buffer, vt2, vf1, vs4, vs4, bodytopfrontside);
		RenderHelper.addFace(buffer, vt3, vf2, vs8, vs8, bodytopfrontside);
		RenderHelper.addFace(buffer, vs3, vs4, vfs2, vfs1, bodysidefrontedge);
		RenderHelper.addFace(buffer, vs7, vs8, vfs4, vfs3, bodysidefrontedge);
		RenderHelper.addFace(buffer, vf2, vs8, vs4, vf1, bodybottomback);
		RenderHelper.addFace(buffer, vfs2, vfs1, vff1, vff2, bodysidefront);
		RenderHelper.addFace(buffer, vfs4, vfs3, vff1, vff2, bodysidefront);
		RenderHelper.addFace(buffer, vb1, vb2, vb3, vb4, bodybottom);
		RenderHelper.addFace(buffer, vs2, vs3, vb2, vb1, bodybottomside);
		RenderHelper.addFace(buffer, vs6, vs7, vb3, vb4, bodybottomside);
		RenderHelper.addFace(buffer, vb2, vfb1, vs3, vs3, bodytopfrontside);
		RenderHelper.addFace(buffer, vb3, vfb2, vs7, vs7, bodytopfrontside);
		RenderHelper.addFace(buffer, vb2, vfb1, vfb2, vb3, bodybottomfront);
		RenderHelper.addFace(buffer, vb1, vs2, vs6, vb4, bodybottomback);
		RenderHelper.addFace(buffer, vfb2, vs7, vs3, vfb1, bodybottomback);

		// bottom
		RenderHelper.addFace(buffer, vbb1, vbt1, vbt4, vbb4, bottomfront);
		RenderHelper.addFace(buffer, vbb3, vbt3, vbt2, vbb2, bottomback);
		RenderHelper.addFace(buffer, vbt2, vbb2, vbb1, vbt1, bottomside);
		RenderHelper.addFace(buffer, vbt3, vbb3, vbb4, vbt4, bottomside);
		RenderHelper.addFace(buffer, vbb3, vbb4, vbb1, vbb2, bottombottom);

		// detail
		RenderHelper.addFace(buffer, vdt4, vdb4, vdb1, vdt1, detailedge1);
		RenderHelper.addFace(buffer, vdt3, vdb3, vdb2, vdt2, detailedge1);
		RenderHelper.addFace(buffer, vdt2, vdb2, vdb1, vdt1, detailedge2);
		RenderHelper.addFace(buffer, vdt4, vdb4, vdb3, vdt3, detailedge2);
		RenderHelper.addFace(buffer, vdb1, vdb2, vdb3, vdb4, detailpurple);

		// handle
		RenderHelper.addFace(buffer, vht4, vhb4, vhb1, vht1, handlefront);
		RenderHelper.addFace(buffer, vht2, vhb2, vhb3, vht3, handlefront);
