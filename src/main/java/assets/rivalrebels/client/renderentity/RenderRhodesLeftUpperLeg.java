...
public class RenderRhodesLeftUpperLeg extends EntityRenderer<EntityRhodesLeftUpperLeg>
{
    ...
    public RenderRhodesLeftUpperLeg(EntityRendererFactory.Context renderManager) {
        super(renderManager);
    }

    @Override
    public void render(EntityRhodesLeftUpperLeg entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
		matrices.push();
    ...
    @Override
    public Identifier getTexture(EntityRhodesLeftUpperLeg entity) {
