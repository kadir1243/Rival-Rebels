...
public class RenderB83 extends Render
{
	...
	public void renderB83(EntityB83 b83, double x, double y, double z, float par8, float par9)
	{
	...
	{
		renderB83((EntityB83) par1Entity, par2, par4, par6, par8, par9);
	}
