...
public class RenderFlameRedBlue extends EntityRenderer<EntityFlameBall1>
{
    ...
    @Override
    public boolean shouldRender(EntityFlameBall1 livingEntity, Frustum camera, double camX, double camY, double camZ) {
        return true;
    }

    @Override
    protected int getBlockLightLevel(EntityFlameBall1 entity, BlockPos pos) {
