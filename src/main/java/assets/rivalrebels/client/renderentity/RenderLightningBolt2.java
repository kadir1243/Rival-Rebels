...
{
    public RenderLightningBolt2(RenderManager renderManager) {
        super(renderManager);
    }
			...
			for (int var19 = 0; var19 < 3; ++var19)
			{
				...
				for (int var26 = var20; var26 >= var21; --var26)
				{
					...
					for (int var36 = 0; var36 < 5; ++var36)
					{
						...
						buffer.pos(var41 + var22, par4 + (var26 * 16), var43 + var24).color(0.9F * var31, 0.9F * var31, var31, 0.3F).endVertex();
						buffer.pos(var37 + var27, par4 + ((var26 + 1) * 16), var39 + var29).color(0.9F * var31, 0.9F * var31, var31, 0.3F).endVertex();
					}
