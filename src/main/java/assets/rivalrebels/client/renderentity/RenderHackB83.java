...
public class RenderHackB83 extends Render<EntityHackB83>
{
    ...
    @Override
    public void doRender(EntityHackB83 b83, double x, double y, double z, float entityYaw, float partialTicks) {
		GL11.glPushMatrix();
	...
	@Override
	protected ResourceLocation getEntityTexture(EntityHackB83 entity)
	{
		return null;
	}
}
