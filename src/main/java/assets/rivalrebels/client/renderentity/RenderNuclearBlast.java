...
public class RenderNuclearBlast extends Render
{
	...
	public void renderNuclearBlast(EntityNuclearBlast enb, double x, double y, double z, float yaw, float pitch)
	{
        ...
        if (enb.ticksExisted > 0 && enb.ticksExisted < 600 + time) {
			addFace(tessellator, pxv1, nzv1, nzv2, pxv2, par5, par6, par7, par8);
			addFace(tessellator, pzv1, pxv1, pxv2, pzv2, par5, par6, par7, par8);
			addFace(tessellator, nxv1, pzv1, pzv2, nxv2, par5, par6, par7, par8);
			addFace(tessellator, nzv1, nxv1, nxv2, nzv2, par5, par6, par7, par8);
		}

		if (enb.ticksExisted > 10 && enb.ticksExisted < 610 + time) {
			addFace(tessellator, pxv2, nzv2, nzv3, pxv3, par5, par6, par7, par8);
			addFace(tessellator, pzv2, pxv2, pxv3, pzv3, par5, par6, par7, par8);
			addFace(tessellator, nxv2, pzv2, pzv3, nxv3, par5, par6, par7, par8);
			addFace(tessellator, nzv2, nxv2, nxv3, nzv3, par5, par6, par7, par8);
		}

		if (enb.ticksExisted > 20 && enb.ticksExisted < 620 + time) {
			addFace(tessellator, pxv3, nzv3, nzv4, pxv4, par5, par6, par7, par8);
			addFace(tessellator, pzv3, pxv3, pxv4, pzv4, par5, par6, par7, par8);
			addFace(tessellator, nxv3, pzv3, pzv4, nxv4, par5, par6, par7, par8);
			addFace(tessellator, nzv3, nxv3, nxv4, nzv4, par5, par6, par7, par8);
		}

        if (enb.ticksExisted > 30 && enb.ticksExisted < 630 + time) {
			addFace(tessellator, pxv4, nzv4, nzv5, pxv5, par5, par6, par7, par8);
			addFace(tessellator, pzv4, pxv4, pxv5, pzv5, par5, par6, par7, par8);
			addFace(tessellator, nxv4, pzv4, pzv5, nxv5, par5, par6, par7, par8);
			addFace(tessellator, nzv4, nxv4, nxv5, nzv5, par5, par6, par7, par8);
		}

		if (enb.ticksExisted > 40 && enb.ticksExisted < 640 + time) {
			addFace(tessellator, pxv5, nzv5, nzv6, pxv6, par5, par6, par7, par8);
			addFace(tessellator, pzv5, pxv5, pxv6, pzv6, par5, par6, par7, par8);
			addFace(tessellator, nxv5, pzv5, pzv6, nxv6, par5, par6, par7, par8);
			addFace(tessellator, nzv5, nxv5, nxv6, nzv6, par5, par6, par7, par8);
		}

		if (enb.ticksExisted > 30 && enb.ticksExisted < 650 + time) {
			addFace(tessellator, pxv6, nzv6, nzv7, pxv7, par6, par5, par8, par7);
			addFace(tessellator, pzv6, pxv6, pxv7, pzv7, par6, par5, par8, par7);
			addFace(tessellator, nxv6, pzv6, pzv7, nxv7, par6, par5, par8, par7);
			addFace(tessellator, nzv6, nxv6, nxv7, nzv7, par6, par5, par8, par7);
		}

		if (enb.ticksExisted > 20 && enb.ticksExisted < 650 + time) {
			addFace(tessellator, pzv7, ppv7, ppv8, pzv8, par6, par5, par8, par7);
			addFace(tessellator, ppv7, pxv7, pxv8, ppv8, par6, par5, par8, par7);
			addFace(tessellator, pxv7, pnv7, pnv8, pxv8, par6, par5, par8, par7);
			addFace(tessellator, pnv7, nzv7, nzv8, pnv8, par6, par5, par8, par7);
			addFace(tessellator, nzv7, nnv7, nnv8, nzv8, par6, par5, par8, par7);
			addFace(tessellator, nnv7, nxv7, nxv8, nnv8, par6, par5, par8, par7);
			addFace(tessellator, nxv7, npv7, npv8, nxv8, par6, par5, par8, par7);
			addFace(tessellator, npv7, pzv7, pzv8, npv8, par6, par5, par8, par7);
		}

		if (enb.ticksExisted > 10 && enb.ticksExisted < 650 + time) {
			addFace(tessellator, pzv8, ppv8, ppv9, pzv9, par6, par5, par8, par7);
			addFace(tessellator, ppv8, pxv8, pxv9, ppv9, par6, par5, par8, par7);
			addFace(tessellator, pxv8, pnv8, pnv9, pxv9, par6, par5, par8, par7);
			addFace(tessellator, pnv8, nzv8, nzv9, pnv9, par6, par5, par8, par7);
			addFace(tessellator, nzv8, nnv8, nnv9, nzv9, par6, par5, par8, par7);
			addFace(tessellator, nnv8, nxv8, nxv9, nnv9, par6, par5, par8, par7);
			addFace(tessellator, nxv8, npv8, npv9, nxv9, par6, par5, par8, par7);
			addFace(tessellator, npv8, pzv8, pzv9, npv9, par6, par5, par8, par7);

			addFace(tessellator, pxv6, pzv6, nxv6, nzv6, par6, par5, par8, par7);

			addTri(tessellator, ppv9, v9, pzv9, par6, par5, par8, par7);
			addTri(tessellator, pxv9, v9, ppv9, par6, par5, par8, par7);
			addTri(tessellator, pnv9, v9, pxv9, par6, par5, par8, par7);
			addTri(tessellator, nzv9, v9, pnv9, par6, par5, par8, par7);
			addTri(tessellator, nnv9, v9, nzv9, par6, par5, par8, par7);
			addTri(tessellator, nxv9, v9, nnv9, par6, par5, par8, par7);
			addTri(tessellator, npv9, v9, nxv9, par6, par5, par8, par7);
			addTri(tessellator, pzv9, v9, npv9, par6, par5, par8, par7);
		}
	...
	private void addFace(Tessellator tessellator, Vertice v1, Vertice v2, Vertice v3, Vertice v4, float par5, float par6, float par7, float par8)
	{
	...
	private void addTri(Tessellator tessellator, Vertice v1, Vertice v2, Vertice v3, float par5, float par6, float par7, float par8)
	{
        WorldRenderer worldRenderer = tessellator.getWorldRenderer();
        worldRenderer.begin(GL_TRIANGLE_FAN, DefaultVertexFormats.POSITION_TEX);
		addVertice(worldRenderer, v3, par5, par8);
		addVertice(worldRenderer, v1, par6, par8);
		addVertice(worldRenderer, v2, par6, par7);
		tessellator.draw();
	}

	private void addVertice(WorldRenderer worldRenderer, Vertice v, double t, double t2) {
		worldRenderer.pos(v.x, v.y, v.z).tex(t, t2).endVertex();
	}
