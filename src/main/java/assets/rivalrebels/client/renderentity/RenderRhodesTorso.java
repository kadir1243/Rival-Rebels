...
public class RenderRhodesTorso extends EntityRenderer<EntityRhodesTorso> {
    ...
    public void render(EntityRhodesTorso entity, float yaw, float tickDelta, PoseStack matrices, MultiBufferSource vertexConsumers, int light) {
        ...
        RenderRhodes.torso.render(TEXTURE.buffer(vertexConsumers, RenderType::entitySolid), new Vector3f(colors[entity.getColor()*3], colors[entity.getColor()*3+1], colors[entity.getColor()*3+2]), light, OverlayTexture.NO_OVERLAY);
        matrices.popPose();
    }
