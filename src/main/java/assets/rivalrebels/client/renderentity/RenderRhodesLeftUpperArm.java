...
{
    public RenderRhodesLeftUpperArm(EntityRendererFactory.Context renderManager) {
        super(renderManager);
    }

    @Override
    public void render(EntityRhodesLeftUpperArm entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
        matrices.push();
    ...
    @Override
    public Identifier getTexture(EntityRhodesLeftUpperArm entity) {
