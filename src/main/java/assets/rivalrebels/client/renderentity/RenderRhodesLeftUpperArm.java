...
public class RenderRhodesLeftUpperArm extends Render
{
	public RenderRhodesLeftUpperArm(RenderManager renderManager) {
        super(renderManager);
    }

	public void renderRhodes(EntityRhodesLeftUpperArm rhodes, double x, double y, double z, float par8, float ptt)
	{
		GL11.glPushMatrix();
	...
	{
		renderRhodes((EntityRhodesLeftUpperArm) par1Entity, par2, par4, par6, par8, par9);
	}
