...
public class NuclearRodRenderer extends BuiltinModelItemRenderer
{
	private final ModelRod md;

	public NuclearRodRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelLoader loader) {
    ...
    public void render(ItemStack stack, ModelTransformation.Mode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
		MinecraftClient.getInstance().getTextureManager().bindTexture(RRIdentifiers.etradrod);
		matrices.push();
