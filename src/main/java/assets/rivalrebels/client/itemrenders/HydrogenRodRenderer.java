...
public class HydrogenRodRenderer extends BuiltinModelItemRenderer
{
	ModelRod	md;

	public HydrogenRodRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelLoader loader) {
