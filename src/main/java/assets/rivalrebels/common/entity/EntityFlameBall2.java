...
public class EntityFlameBall2 extends EntityInanimate
{
	...
	private void fire()
	{
		if (!worldObj.isRemote)
		{
			...
			if (id == Blocks.air || id == Blocks.snow || id == Blocks.ice) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.fire);
			else if (id == Blocks.sand && worldObj.rand.nextInt(60) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.glass);
			else if (id == Blocks.glass && worldObj.rand.nextInt(120) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.obsidian);
			else if (id == Blocks.obsidian && worldObj.rand.nextInt(90) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if ((id == Blocks.stone || id == Blocks.cobblestone) && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.iron_ore && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.coal_ore && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.gold_ore && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.lapis_ore && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.gravel && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.sandstone && worldObj.rand.nextInt(30) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.iron_block && worldObj.rand.nextInt(50) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if (id == Blocks.bedrock && worldObj.rand.nextInt(500) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.obsidian);
			else if (id == Blocks.lava) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.air);
			else if (id == Blocks.leaves || id == Blocks.leaves2) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.fire);
			else if (id == Blocks.grass) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.dirt);
			else if (id == Blocks.dirt) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.fire);
			else if (id == RivalRebels.flare) RivalRebels.flare.onBlockDestroyedByPlayer(worldObj, (int) posX, (int) posY, (int) posZ, 0);
			else if (id == RivalRebels.timedbomb) RivalRebels.timedbomb.onBlockDestroyedByPlayer(worldObj, (int) posX, (int) posY, (int) posZ, 0);
			else if (id == RivalRebels.remotecharge) RivalRebels.remotecharge.onBlockDestroyedByPlayer(worldObj, (int) posX, (int) posY, (int) posZ, 0);
			else if (id == RivalRebels.landmine) RivalRebels.remotecharge.onBlockDestroyedByPlayer(worldObj, (int) posX, (int) posY, (int) posZ, 0);
			else if (id == RivalRebels.alandmine) RivalRebels.remotecharge.onBlockDestroyedByPlayer(worldObj, (int) posX, (int) posY, (int) posZ, 0);
			...
			else if (id == RivalRebels.conduit) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.fire);
			else if (id == RivalRebels.reactive && worldObj.rand.nextInt(20) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.lava);
			else if ((id == RivalRebels.camo1 || id == RivalRebels.camo2 || id == RivalRebels.camo3) && worldObj.rand.nextInt(40) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, RivalRebels.steel);
			else if (id == RivalRebels.steel && worldObj.rand.nextInt(40) == 0) worldObj.setBlock((int) posX, (int) posY, (int) posZ, Blocks.fire);
		}
	}
	// private int xTile;
	// private int yTile;
