...
public class EntityRoddiskRebel extends RoddiskBase {
	...
	public void tick() {
        ...
        world.getOtherEntities(null, new Box(nx, ny, nz, px, py, pz), entity -> entity instanceof ArrowEntity).forEach(Entity::kill);
		...
		if (var3 != null)
		{
			...
			if (var3.getType() == HitResult.Type.ENTITY) {
				...
				{
					entityHit.damage(RivalRebelsDamageSource.tron, 10);
