...
public class EntityRoddiskRebel extends EntityInanimate
{
	...
	public void setHeading(double par1, double par3, double par5, float par7, float par8)
	{
		...
		par3 /= var9;
		par5 /= var9;
		par1 += this.rand.nextGaussian() * 0.0075 * par8;
		par3 += this.rand.nextGaussian() * 0.0075 * par8;
		par5 += this.rand.nextGaussian() * 0.0075 * par8;
		par1 *= par7;
		par3 *= par7;
		par5 *= par7;
		this.motionX = par1;
				...
				if (var3.entityHit instanceof EntityPlayer entityPlayerHit && shooter instanceof EntityPlayer && var3.entityHit != shooter)
				{
                    for (ItemStack armorSlot : entityPlayerHit.inventory.armorInventory) {
                        if (!armorSlot.isEmpty()) {
                            armorSlot.damageItem(10, entityPlayerHit);
