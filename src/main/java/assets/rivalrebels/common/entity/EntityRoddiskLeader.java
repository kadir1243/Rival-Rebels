	...
	public void tick() {
		...
		if (var3 != null)
		{
			...
			if (var3.getType() == HitResult.Type.ENTITY)
			{
				...
				{
					entityHit.damage(RivalRebelsDamageSource.tron(getWorld()), 15);
					...
					{
						entityHit.kill();
						this.getWorld().spawnEntity(new EntityGore(getWorld(), entityHit, 0, 1));
						this.getWorld().spawnEntity(new EntityGore(getWorld(), entityHit, 1, 1));
						this.getWorld().spawnEntity(new EntityGore(getWorld(), entityHit, 2, 1));
						this.getWorld().spawnEntity(new EntityGore(getWorld(), entityHit, 2, 1));
						this.getWorld().spawnEntity(new EntityGore(getWorld(), entityHit, 3, 1));
						this.getWorld().spawnEntity(new EntityGore(getWorld(), entityHit, 3, 1));
					}
				}
			}
