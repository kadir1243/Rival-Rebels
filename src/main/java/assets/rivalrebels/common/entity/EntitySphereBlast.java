...
public class EntitySphereBlast extends EntityTsarBlast
{
	...
	public void onUpdate()
	{
		...
		{
			world.playSound(this.posX, posY, posZ, SoundEvents.ENTITY_LIGHTNING_THUNDER, SoundCategory.MASTER, 10.0F, 0.50F, true);
		}
		else
		{
			if (world.rand.nextInt(5) == 0) RivalRebelsSoundPlayer.playSound(this, 26, 0, 100, 0.7f);
		}
	...
	public void pushAndHurtEntities()
	{
		...
		List var9 = world.getEntitiesWithinAABBExcludingEntity(this, new AxisAlignedBB(var3, var5, var7, var4, var28, var29));
