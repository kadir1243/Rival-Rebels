...
public class EntityTachyonBomb extends EntityThrowable
{
	...
	protected void onImpact(RayTraceResult var1)
	{
		...
		{
			IBlockState b = world.getBlockState(var1.getBlockPos());
			Material m = b.getMaterial();
			if (b.getBlock() == RivalRebels.jump || b.getBlock() == Blocks.ICE)
			{
    ...
    public void explode()
	{
		if (!world.isRemote)
		{
			TachyonBomb tsar = new TachyonBomb((int)posX, (int)posY, (int)posZ, world, (int) ((RivalRebels.tsarBombaStrength + (aoc * aoc)) * 1.0f));
			EntityTachyonBombBlast tsarblast = new EntityTachyonBombBlast(world, (int)posX, (int)posY, (int)posZ, tsar, RivalRebels.tsarBombaStrength + (aoc * aoc));
