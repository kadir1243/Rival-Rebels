...
public class EntityTachyonBomb extends ThrownEntity
{
    ...
    public void explode()
	{
		if (!world.isClient)
		{
			TachyonBomb tsar = new TachyonBomb((int)getX(), (int)getY(), (int)getZ(), world, (int) ((RivalRebels.tsarBombaStrength + (aoc * aoc)) * 1.0f));
			EntityTachyonBombBlast tsarblast = new EntityTachyonBombBlast(world, (int)getX(), (int)getY(), (int)getZ(), tsar, RivalRebels.tsarBombaStrength + (aoc * aoc));
