...
public class EntityTheoreticalTsar extends ThrownEntity
{
    ...
    public void explode()
	{
		if (!world.isClient)
		{
			TsarBomba tsar = new TsarBomba((int)getX(), (int)getY(), (int)getZ(), world, (int) ((RivalRebels.tsarBombaStrength + (aoc * aoc)) * 0.6f));
			EntityTheoreticalTsarBlast tsarblast = new EntityTheoreticalTsarBlast(world, (int)getX(), (int)getY(), (int)getZ(), tsar, RivalRebels.tsarBombaStrength + (aoc * aoc));
