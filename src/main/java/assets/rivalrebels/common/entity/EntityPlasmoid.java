...
public class EntityPlasmoid extends EntityInanimate
{
	...
	protected void explode()
	{
		if (!worldObj.isRemote)
		{
			...
			{
				++i;
				block = worldObj.getBlockState(new BlockPos((int) (posX - motionX * i), (int) (posY - motionY * i), (int) (posZ - motionZ * i))).getBlock();
			}
			worldObj.setBlockState(new BlockPos((int) (posX - motionX * i), (int) (posY - motionY * i), (int) (posZ - motionZ * i)), RivalRebels.plasmaexplosion.getDefaultState());
		}
	}
