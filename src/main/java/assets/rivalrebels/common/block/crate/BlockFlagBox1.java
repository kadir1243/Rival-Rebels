...
public class BlockFlagBox1 extends Block
{
	...
	public boolean blockActivated(World world, int x, int y, int z, EntityPlayer player)
	{
		...
		{
			EntityItem ei = new EntityItem(world, x + .5, y + .5, z + .5, new ItemStack(RivalRebels.flag1, 10));
		...
		if (!player.isSneaking() && !world.isRemote)
		{
			...
			world.setBlockState(new BlockPos(x, y, z), RivalRebels.flagbox5.getDefaultState());
			return false;
		}
		return false;
	}
