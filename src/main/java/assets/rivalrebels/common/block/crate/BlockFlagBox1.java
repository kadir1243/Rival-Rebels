...
{
	public BlockFlagBox1(Settings settings)
	{
		super(settings);
	}
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
		...
		{
			ItemEntity ei = new ItemEntity(world, x + .5, y + .5, z + .5, new ItemStack(RRBlocks.flag1, 10));
		...
		if (!player.isSneaking() && !world.isClient)
		{
			...
			world.setBlockState(new BlockPos(x, y, z), RRBlocks.flagbox5.getDefaultState());
			return ActionResult.PASS;
		}
		return ActionResult.PASS;
	}
	...
	public void registerBlockIcons(IIconRegister iconregister)
	{
		...
		icon2 = iconregister.registerIcon("RivalRebels:bi"); // TOP
