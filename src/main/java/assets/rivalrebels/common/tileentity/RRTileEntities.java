...
public class RRTileEntities {
    ...
    public static final BlockEntityType<OmegaObjectiveBlockEntity> OMEGA_OBJECTIVE = BlockEntityType.Builder.of(OmegaObjectiveBlockEntity::new, RRBlocks.omegaobj).build(null);
    ...
    public static final BlockEntityType<SigmaObjectiveBlockEntity> SIGMA_OBJECTIVE = BlockEntityType.Builder.of(SigmaObjectiveBlockEntity::new, RRBlocks.sigmaobj).build(null);
