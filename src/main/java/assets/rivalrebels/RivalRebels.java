...
public class RivalRebels {
	...
	{
		int nextNum = 0;
		amario = (new BlockMario()).setCreativeTab(rralltab).setHardness(1.5F).setResistance(10F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		aquicksand = (new BlockQuickSand()).setCreativeTab(rralltab).setHardness(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		barricade = (new BlockAutoBarricade()).setHardness(0.7F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		tower = (new BlockAutoTower()).setHardness(0.7F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		easteregg = (new BlockAutoEaster()).setHardness(0.5F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		bunker = (new BlockAutoBunker()).setHardness(0.5F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		smartcamo = (new BlockSmartCamo()).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.block." + (nextNum++));
		camo1 = (new BlockCamo1()).setHardness(2F).setResistance(25F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		...
		flagbox3 = (new BlockFlagBox3()).setBlockUnbreakable().setCreativeTab(rrarmortab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		flagbox4 = (new BlockFlagBox4()).setBlockUnbreakable().setCreativeTab(rrarmortab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		flagbox7 = (new BlockFlagBox7()).setBlockUnbreakable().setCreativeTab(rrarmortab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		sigmaarmor = (new BlockSigmaArmor()).setHardness(0.5F).setResistance(10F).setCreativeTab(rrarmortab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		omegaarmor = (new BlockOmegaArmor()).setHardness(0.5F).setResistance(10F).setCreativeTab(rrarmortab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		weapons = (new BlockWeapons()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		ammunition = (new BlockAmmunition()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		explosives = (new BlockExplosives()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		supplies = (new BlockSupplies()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		mario = (new BlockMario()).setHardness(1.5F).setResistance(10F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		jump = (new BlockJump()).setHardness(2.0F).setResistance(5F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		quicksand = (new BlockQuickSand()).setHardness(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		landmine = (new BlockLandMine()).setResistance(1F).setHardness(0.6F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		remotecharge = (new BlockRemoteCharge()).setHardness(0.5F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		timedbomb = (new BlockTimedBomb()).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		flare = (new BlockFlare()).setLightLevel(0.5F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		light = (new BlockLight(23)).setLightLevel(1.0F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		light2 = (new BlockLight(-1)).setLightLevel(1.0F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		cycle = (new BlockCycle()).setCreativeTab(rrarmortab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		toxicgas = (new BlockToxicGas()).setBlockUnbreakable().setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		fshield = (new BlockForceShield()).setHardness(0.2F).setResistance(10F).setLightOpacity(0).setLightLevel(0.25F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		gamestart = (new BlockGameStart()).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		breadbox = (new BlockBreadBox()).setCreativeTab(rralltab).setBlockUnbreakable().setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		alandmine = (new BlockLandMine()).setCreativeTab(rralltab).setResistance(1F).setHardness(0.6F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		nuclearBomb = (new BlockNuclearBomb()).setHardness(5.0F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		nukeCrateTop = (new BlockNukeCrate()).setCreativeTab(rralltab).setHardness(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		nukeCrateBottom = (new BlockNukeCrate()).setCreativeTab(rralltab).setHardness(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		radioactivedirt = (new BlockRadioactiveDirt()).setCreativeTab(rralltab).setHardness(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		radioactivesand = (new BlockRadioactiveSand()).setCreativeTab(rralltab).setHardness(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		plasmaexplosion = (new BlockPlasmaExplosion()).setLightLevel(1.0F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		reactor = (new BlockReactor()).setHardness(1.0F).setResistance(10F).setLightLevel(1.0F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		loader = (new BlockLoader()).setHardness(2.0F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		...
		reactive = (new BlockReactive()).setHardness(2F).setResistance(100F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		bastion = (new BlockAutoForceField()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		conduit = (new BlockConduit()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		controller = (new BlockLaptop()).setHardness(0.3F).setResistance(1F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		mariotrap = (new BlockAutoMarioTrap()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		minetrap = (new BlockAutoMineTrap()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		quicksandtrap = (new BlockAutoQuickSandTrap()).setHardness(0.5F).setResistance(10F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		forcefield = (new BlockForceField()).setHardness(1000000F).setResistance(1000000F).setLightLevel(0.5F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		meltdown = (new BlockMeltDown()).setHardness(0.5F).setResistance(10F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		ffreciever = (new BlockReciever()).setHardness(2F).setResistance(100F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		buildrhodes = (new BlockRhodesScaffold()).setHardness(2F).setResistance(100F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		rhodesactivator = (new BlockRhodesActivator()).setHardness(0.1F).setResistance(100F).setCreativeTab(rralltab).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
		theoreticaltsarbombablock = (new BlockTheoreticalTsarBomba()).setHardness(5.0F).setLightLevel(0.4F).setUnlocalizedName("rivalrebels.blocks." + (nextNum++));
